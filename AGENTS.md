...
- A pinned CN Quickstart bootstrap, containerized Quickstart-DAR bridge build, and LocalNet package-deployment command now exist under `infra/quickstart/` plus `scripts/`, but seeded confidential collateral scenarios and live asset adapters are still intentionally absent.
