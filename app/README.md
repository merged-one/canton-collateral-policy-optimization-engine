...
- `app/orchestration/` for the end-to-end margin-call, return, and substitution scenario runners, the aggregate conformance suite, and the final demo-pack generation paths
